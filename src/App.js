...
const CompleteRegistrationPage = lazy(() =>
    import("./pages/kayit-tamamla/index")
);
...
export default function App() {
                    ...
                    <HelmetProvider>
                        <Suspense fallback={<Loading />}>
                            <Switch>
                                ...
                                />
                                <Route
                                    path='/ceviriler/manga/:slug/oku/:episode_number?/:page_number?'
                                    exact
                                    component={MangaEpisodePage}
                                />
                                <Wrapper>
                                    <Switch>
                                        <Route
                                        ...
                                        />
                                        <Route
                                            path='/ceviriler/anime/:slug/izle/:episodeInfo?'
                                            exact
                                            component={EpisodePage}
                                        />
                                        <Route
                                            path='/ceviriler/anime/:slug'
                                            exact
                                            component={AnimePage}
                                        />
                                        <Route
                                            path='/ceviriler/manga/:slug'
                                            exact
                                            component={MangaPage}
                                        />
                                        <Route
                                            path='/ara/:type?/:offset?'
                                        ...
                                        <Route
                                            path='/ekip-alimlari'
                                            exact
                                            component={EkipAlimlariPage}
                                        />
                                        <Route
                                            path='/kullanici/kayit-tamamla/:hash'
                                            exact
    ...
    else if (!siteStatus.loading && !siteStatus.status)
        return <InitialLoading error={true} />;
    else return <InitialLoading error={false} />;
}
