                ...
                <div className={classes.BackgroundContainer}>
                        ...
                        <div className={classes.TextContainer}>
                            <Box mb={2}>
                                <Typography
                                    variant='h4'
                                    component='h6'
                                    className={classes.PremieredContainer}
                                >
                                ...
                                >
                                    {synopsis
                                        ? synopsis
                                        : t(
                                              "common:warnings.not_found_synopsis"
                                          )}
                                </Typography>
                            </Box>
                            <Box display='flex' flexWrap='wrap'>
                                <MetadataContainer
                                    title={t("common:ns.translator", {
                                        count: translators.length,
                                    })}
                                    list={translators}
                                />
                                <MetadataContainer
                                    title={t("common:ns.encoder", {
                            ...
                            <Box display='flex' flexWrap='wrap'>
                                ...
                                <MetadataContainer
                                    ...
                                    list={[Format(new Date(release_date))]}
                                />
                            </Box>
                            <Box mt={2}>
                                {episodes.length !== 0 ? (
                    ...
                    <div className={classes.BackgroundImage}>
                        ...
                        <img
                            ...
                            onError={(img) => {
                                img.target.src = coverArtError
                                    ? cover_art
                                    : contentCover("anime", slug);
                                setHeaderError(true);
                            }}
                        ></img>
                            ...
                            <Grid item xs={12}>
                                ...
                                <ul>
                                    ...
                                    {downloadLinks.length !== 0 ? (
                                        ...
                                        <WarningBox>
                                            {t(
                                                "translations.warnings.anime.not_found_download_links"
                                            )}
                                        </WarningBox>
                                    )}
                                </ul>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} md={12} lg={6} xl={4}>
                            <JikanStatsScoresChart
                                data={jikanScoreData}
                                loading={jikanScoreStatusDataLoading}
                            />
                        </Grid>
                        <Grid item xs={12} md={12} lg={6} xl={4}>
                            <JikanStatsStatusChart
                                data={jikanStatusData}
                                loading={jikanScoreStatusDataLoading}
                            />
                        </Grid>
                        <Grid item xs={12} md={12} lg={6} xl={4}>
                        ...
                        <Grid item xs={12} md={12} lg={6}>
                            <CharactersStaffBox
                                data={jikanCharactersData}
                                type='characters'
                                loading={jikanCharacterStaffDataLoading}
                            />
                        </Grid>
                        <Grid item xs={12} md={12} lg={6}>
                            <CharactersStaffBox
        ...
        <Box mr={1}>
            ...
            {list.length !== 0 ? (
                ...
                <Typography variant='body1'>
                    {t("translations.warnings.content_metadata.not_found", {
                        title: title,
                    })}
                </Typography>
            )}
        ...
        <>
            ...
            {data.length ? (
                        ...
                        <div style={{ height: 200 }}>
                            <ResponsiveBar
                                ...
                                labelFormat={(d) => (
                                    <tspan
                                        className={
                                            classes.JikanStatsScoresChartText
                                        }
                                        y={-10}
                                    >
                                        {d}
                ...
                <div className={classes.JikanDataErrorBox}>
                    ...
                    <Typography variant='body1'>
                        {t(
                            "components:translations.jikan_errors.couldnt_reach_data"
                        )}
                    </Typography>
                </div>
            )}
                ...
                <div className={classes.JikanStatsStatusChart}>
                    <div className={classes.JikanStatsStatusChartList}>
                        {Object.keys(data).map((key) => (
                            <div
                                key={key}
                                className={classes.JikanStatsStatusChartItem}
                            >
                                <div
                                    style={{
                                    ...
                                    className={
                                        classes.JikanStatsStatusChartItemHeaderText
                                    }
                                >
            ...
            {link ? (
                ...
                <>
                    <div className={classes.JikanDataErrorBox}>
                        ...
                        <Typography variant='body1'>
                            {t(
                                "components:translations.warnings.youtube_pv.not_found"
                            )}
                        </Typography>
                    </div>
                </>
...
function CharactersStaffBox(props) {
    ...
    const classes = useStyles({ open: type === "characters" ? open : false });
                        ...
                        {currentData.map((d) => {
                            ...
                            return (
                                <div
                                    key={d.url}
                                    className={`${
                                        classes.CharactersStaffBoxItem
                                    }  ${
                                        type === "characters"
                                            ? `${classes.CharactersStaffBoxCharacter}`
                                            : `${classes.CharactersStaffBoxStaff}`
                                    } `}
                                >
                                    <div
                                        className={`${
                                            classes.CharactersStaffBoxItemCharacter
                                        } ${
                                            type === "characters"
                                                ? "chr"
                                                : `${classes.CharactersStaffBoxStaffOverride} stff`
                                        } `}
                                    >
                                        <a
                                            href={d.url}
                                        ...
                                        >
                                            <div
                                                ...
                                                className={
                                                    classes.CharactersStaffBoxItemImage
                                                }
                                            />
                                        </a>
                                        <div
                                            className={
                                                classes.CharactersStaffBoxItemText
                                            }
                                        >
                                    ...
                                    {type === "characters" && va && open ? (
                                        <div
                                            className={`${classes.CharactersStaffBoxItemStaff} stff`}
                                        >
                                            <div
                                                className={
                                                    classes.CharactersStaffBoxItemText
